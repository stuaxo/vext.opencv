...
info="""
Allow use of system OpenCV from a virtualenv
...
setup(
    name='vext.OpenCV',
    version=version,
    description='Use system OpenCV from a virtualenv',
    ...
    keywords='virtualenv opencv 3d vext',
